...
export const DrugInteractionIcon = () => (
...
export const PracticeUpdatesIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor">
...
export const WhatsNewIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor">
    <path d="M20 12v7a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2v-7" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M12 3v12m0-12L8 7m4-4l4 4" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);

export const PatientEducationIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor">
...
export const CalculatorsIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor">
    ...
    <line x1="8" y1="7" x2="16" y2="7" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
